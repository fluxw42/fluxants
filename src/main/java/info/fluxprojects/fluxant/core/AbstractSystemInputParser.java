...
public abstract class AbstractSystemInputParser extends AbstractSystemInputReader {
    ...
    protected abstract Set<Order> validateOrders(Set<Order> orders);

    protected abstract void afterTurn(Set<Order> orders);
     ...
     */
    public abstract Set<Order> doTurn();

    /**
     * Finishes turn.
     */
    public void finishTurn(Set<Order> orders) {
